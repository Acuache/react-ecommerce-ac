...
export default function FrontPage() {
    return (
        <main className="mb-30 md:mb-0 w-full max-h-[calc(100dvh-40px)] flex flex-col items-center bg-BGGray-light mt-10">
            <div className="pt-6 w-full flex-grow flex flex-col items-center px-4 gap-2 max-w-7xl md:flex-row md:justify-center md:items-center max-h-[calc(100dvh-40px)] ">
                ...
                <figure className="flex-grow basis-1/3 flex md:basis-1/3 md:self-end bg-red-200 p-2 max-h-[calc(100dvh-40px)] overflow-hidden">
